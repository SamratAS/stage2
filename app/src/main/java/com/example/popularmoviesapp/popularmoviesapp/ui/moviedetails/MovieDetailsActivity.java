package com.example.popularmoviesapp.popularmoviesapp.ui.moviedetails;
...
import com.example.popularmoviesapp.popularmoviesapp.databinding.ActivityMovieDetailsBinding;
...
import com.example.popularmoviesapp.popularmoviesapp.utilities.AppUtils;
import com.squareup.picasso.Picasso;

public class MovieDetailsActivity extends AppCompatActivity implements com.example.popularmoviesapp.popularmoviesapp.ui.moviedetails.MovieDetailsNavigator {

    public final static String ARG_MOVIE = "movie";

    private ActivityMovieDetailsBinding activityMovieDetailsBinding;
    private com.example.popularmoviesapp.popularmoviesapp.ui.moviedetails.MovieDetailsViewModel mViewModel;
    private Snackbar mSnackbar;
    private Movie mMovie;
    private com.example.popularmoviesapp.popularmoviesapp.ui.moviedetails.TrailersAdapter trailersAdapter;
    private com.example.popularmoviesapp.popularmoviesapp.ui.moviedetails.ReviewsAdapter reviewsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders
                .of(this, new com.example.popularmoviesapp.popularmoviesapp.ui.moviedetails.MovieDetailsViewModelFactory(getApplication(), RepoFactory.getDataRepository(), mMovie))
                .get(com.example.popularmoviesapp.popularmoviesapp.ui.moviedetails.MovieDetailsViewModel.class);
        ...
        mViewModel.getReviewsLiveData()
                .observe(this, response -> {
                    reviewsAdapter = new com.example.popularmoviesapp.popularmoviesapp.ui.moviedetails.ReviewsAdapter(response);
                    activityMovieDetailsBinding.content.reviewsRv.setAdapter(reviewsAdapter);
                });
        mViewModel.getTrailersLiveData()
                .observe(this, response -> {
                    trailersAdapter = new com.example.popularmoviesapp.popularmoviesapp.ui.moviedetails.TrailersAdapter(response);
